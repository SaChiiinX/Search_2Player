...
;;  Also, notice that default initial values are specified for some
;;  of the fields.
...
(defun build-path (goal-node)
  ...
  ;; LABELS is a special form (similar to LETREC in Scheme)
  ;; that is used to define recursive helper functions.
